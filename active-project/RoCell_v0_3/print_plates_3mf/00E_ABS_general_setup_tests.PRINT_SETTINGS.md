...
- Purpose: ABS general clearance, screw-head, washer, camera-hex, and TPU-retention setup tests
- Stage / selection: `diagnostic` / `required`
- Material class: **QIDI ABS Rapido**
- Components: `hardware_fit_gauge.stl` × 1, `setup_hardware_fit_gauge.stl` × 1, `tpu_tip_retention_gauge.stl` × 1
- Required gates: `plus4_machine_confirmed`, `plus4_protected_envelope_verified`, `nozzle_0p4_confirmed`, `abs_rapido_general_profile_calibrated`
