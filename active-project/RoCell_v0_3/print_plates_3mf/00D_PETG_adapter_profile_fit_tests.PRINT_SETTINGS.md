...
- Purpose: Phone-stylus-route sliding-fit qualification using the exact adapter profile
- Stage / selection: `diagnostic` / `phone_stylus_route`
- Material class: **PETG**
- Components: `stylus_diameter_gauge.stl` × 1
- Required gates: `plus4_machine_confirmed`, `plus4_protected_envelope_verified`, `nozzle_0p4_confirmed`, `petg_adapter_profile_calibrated`
