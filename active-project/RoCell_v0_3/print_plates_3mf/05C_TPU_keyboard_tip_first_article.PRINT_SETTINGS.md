...
- Purpose: One keyboard TPU tip for dimensional and pull-off acceptance
- Stage / selection: `first_article` / `keyboard_rod_route`
- Material class: **TPU 95A**
- Components: `keyboard_tip_TPU_6mm.stl` × 1
- Required gates: `plus4_machine_confirmed`, `plus4_protected_envelope_verified`, `nozzle_0p4_confirmed`, `tpu_profile_calibrated`, `keyboard_rod_measured`, `qidi_studio_roundtrip_confirmed`
