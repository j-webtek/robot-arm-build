...
- Purpose: One phone TPU tip for dimensional and pull-off acceptance
- Stage / selection: `first_article` / `required`
- Material class: **TPU 95A**
- Components: `phone_clamp_tip_TPU_M4.stl` × 1
- Required gates: `plus4_machine_confirmed`, `plus4_protected_envelope_verified`, `nozzle_0p4_confirmed`, `tpu_profile_calibrated`, `qidi_studio_roundtrip_confirmed`
