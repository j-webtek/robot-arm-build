...
- Purpose: First fixed-mast fallback foot with rear-lug clamp bolts; not part of the intended arm-mounted camera architecture
- Stage / selection: `first_article` / `camera_mast_optional`
- Material class: **ASA**
- Components: `mast_foot_2020.stl` × 1
- Required gates: `fixed_camera_fallback_architecture_released`, `plus4_machine_confirmed`, `plus4_protected_envelope_verified`, `nozzle_0p4_confirmed`, `asa_profile_calibrated`, `asa_mast_socket_coupon_pass`, `asa_m5_nut_coupon_pass`, `asa_m5_clearance_coupon_pass`, `geometry_matches_measurements`, `qidi_studio_roundtrip_confirmed`
