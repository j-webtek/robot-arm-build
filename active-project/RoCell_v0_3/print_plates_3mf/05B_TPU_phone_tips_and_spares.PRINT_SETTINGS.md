...
- Purpose: Three additional phone TPU tips, yielding two installed and two total spares
- Stage / selection: `production` / `required`
- Material class: **TPU 95A**
- Components: `phone_clamp_tip_TPU_M4.stl` × 3
- Required gates: `plus4_machine_confirmed`, `plus4_protected_envelope_verified`, `nozzle_0p4_confirmed`, `tpu_profile_calibrated`, `phone_tpu_retention_coupon_pass`, `qidi_studio_roundtrip_confirmed`
