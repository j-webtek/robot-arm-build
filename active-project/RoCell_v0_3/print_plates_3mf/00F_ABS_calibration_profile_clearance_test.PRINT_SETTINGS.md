...
- Purpose: ABS M3 clearance and M3 button-head recess verification using the exact fine-layer calibration-puck profile
- Stage / selection: `diagnostic` / `required`
- Material class: **QIDI ABS Rapido**
- Components: `hardware_fit_gauge.stl` × 1, `m3_head_fit_gauge.stl` × 1
- Required gates: `plus4_machine_confirmed`, `plus4_protected_envelope_verified`, `nozzle_0p4_confirmed`, `abs_rapido_calibration_profile_calibrated`
