...
[← Step 05](<../05 - Place and Secure Keyboard/00 - START HERE.md>) | [Build dashboard](<../00 - START HERE.md>) | Next step locked
...
**Engineering name:** Install the phone and TCP service station

## Goal

Establish the phone/TCP coordinate system from its round and radial locator pair before the shared service rail is added.

## Finished when

The combined station is seated on two pins with only the TCP-side retainer installed; both rail-side interfaces remain open.
