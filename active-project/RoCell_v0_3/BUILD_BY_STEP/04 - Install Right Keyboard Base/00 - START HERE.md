...
[← Step 03](<../03 - Install Left Keyboard Base/00 - START HERE.md>) | [Build dashboard](<../00 - START HERE.md>) | Next step locked
...
**Engineering name:** Join and retain the keyboard slave station

## Goal

Extend the keyboard support from the master seam without creating a second, conflicting locator system.

## Finished when

The right/slave station is seam-located, held by three relieved board interfaces, flush with the master, and free of rocking.
