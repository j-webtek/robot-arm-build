...
## 00-B — All diagnostic fits are selected from the matching production profile

- Method: Measure and cycle the actual hardware in each coupon
- Pass limit: Every required coupon gate is PASS
- Required evidence: Raw dimensions, photos, and selected option IDs
- Required record: value or observation
- Required record: unit and instrument ID
- Required record: original evidence file path
- Required record: PASS or FAIL result
