...
| complete, read | — | [ASSEMBLY_MANUAL.pdf](<../../../ASSEMBLY_MANUAL.pdf>) | controlled detailed manual, controlled procedure | `3f82933f75bb…` |
...
| verify_not_physical_release | — | [RELEASE_VALIDATION.json](<../../../RELEASE_VALIDATION.json>) | digital package validation | `f756ecf66979…` |
| reference_only | — | [cad/step/RoCell_RC03_INT_R1_full_assembly.step](<../../../cad/step/RoCell_RC03_INT_R1_full_assembly.step>) | assembly reference | `940c6ac34802…` |
...
| use_with_helper | — | [fiducials/apriltag_map.json](<../../../fiducials/apriltag_map.json>) | runtime tag map | `81c867d28660…` |
| view | — | [output/assembly_guide/images/15_final_cell.png](<../../../output/assembly_guide/images/15_final_cell.png>) | assembly-step illustration | `a63cdd293b9c…` |
| complete, read | — | [output/pdf/RC03_ILLUSTRATED_ASSEMBLY_GUIDE.pdf](<../../../output/pdf/RC03_ILLUSTRATED_ASSEMBLY_GUIDE.pdf>) | complete illustrated guide, visual procedure and signoff | `1084103edb5f…` |
...
| run_from_project_root | — | [software_helpers/detect_apriltags.py](<../../../software_helpers/detect_apriltags.py>) | final vision verification | `4fb2e59d6ae3…` |
