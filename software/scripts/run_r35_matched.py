"""One explicitly admitted r35 twelve-leg matched campaign; no reset or retry.
...
def preflight(root, startup_export):
    binding=review_recovery_startup(root,startup_export,revision=35)
    exports=root/'runs/wizard-exports'
    boot=binding['expected_boot']
    claim=exports/f'r35-capture-{boot}.json'
    if claim.exists():
