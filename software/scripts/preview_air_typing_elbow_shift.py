"""Export model-only shifted-elbow sweep from retained r81 A pose."""
import json
from pathlib import Path

from rocell.application.air_typing_elbow_shift_recipe import preview,review_source
...
if __name__=="__main__":
    ...
    saved=exporter.export({"mode":"air-typing-elbow-shift-preview"},[],attachments={
        "air-typing-elbow-shift-preview.json":canonical(report)})
    if not verify_export(Path(saved["path"]))["valid"]:
        raise ValueError("Elbow-shift preview export invalid")
