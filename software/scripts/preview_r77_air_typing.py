"""Export the r77 seven-leg offline sweep; no controller connection."""
import json
from pathlib import Path

from rocell.application.air_typing_r77_preview import preview
...
def main():
    ...
    saved = exporter.export({"mode":"r77-air-typing-offline-sweep"},[],attachments={
        "r77-air-typing-preview.json":canonical(result)})
