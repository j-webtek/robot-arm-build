"""Export an offline-only, source-bound multi-joint hover preview."""
import json
from pathlib import Path

from rocell.application.air_typing_multi_hover_recipe import preview, review_source
...
if __name__ == "__main__":
    ...
    saved = exporter.export({"mode": "air-typing-multi-hover-preview"}, [], attachments={
        "air-typing-multi-hover-preview.json": canonical(report)})
    if not verify_export(Path(saved["path"]))["valid"]:
        raise ValueError("Multi-hover preview export invalid")
