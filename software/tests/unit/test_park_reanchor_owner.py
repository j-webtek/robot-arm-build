...
def binary(tmp_path_factory):
    ...
    target = tmp_path_factory.mktemp('park-reanchor-owner') / 'test.exe'
...
@pytest.mark.parametrize('mode', [
    'success', 'start_mismatch', 'prewrite_changed', 'out_of_bounds',
    'timeout', 'write_uncertain', 'feedback_failed',
])
def test_park_reanchor_owner(binary, mode):
