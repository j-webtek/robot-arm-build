...
def runner(monkeypatch):
    ...
    spec=importlib.util.spec_from_file_location('p4_correction_runner',
        ROOT/'scripts/run_p4_correction_campaign.py')
...
def test_one_use_claim_precedes_host(runner,monkeypatch,tmp_path,wrong_boot):
    ...
    monkeypatch.setattr(runner,'P4CorrectionHost',Host)
