...
The unit is a seed group: maximum key error across all keys and three conditions.
...
def evaluate(manifest_path,checkpoint):
    ...
    def measure(seeds):
        ...
        for seed in seeds:
            ...
            for condition in manifest['conditions']:
                ...
                cases.append({'condition':condition,'image_sha256':hashlib.sha256(stream.getvalue()).hexdigest(),
    ...
    core={'schema':'rocell.ai_localization_radius_study.v0',
          ...
          'limitations':['Empirical nearest-rank calibration, not a statistical coverage guarantee',
                         'Group score is worst error over 46 keys and three correlated conditions',
