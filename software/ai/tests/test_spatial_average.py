...
from vision.evaluate_spatial_average import average_pose


def test_circular_mean_crosses_pi_correctly():
    p=average_pose([(1,2,math.pi-.1),(3,4,-math.pi+.1)])
...
def test_frozen_evidence_and_recount():
    ...
    r=json.loads((AI/'eval/spatial_average_v0_scorecard.json').read_text())
    ...
    for condition in m['conditions']:
        ...
        a,b=r['summaries'][condition]['control'],r['summaries'][condition]['averaged']
