...
def test_frozen_provenance_cases_and_acceptance():
    path=AI/'eval/dark_only_normalization_v0.manifest.json'
    m=json.loads(path.read_text());r=json.loads((AI/'eval/dark_only_normalization_v0_scorecard.json').read_text())
...
def test_bypass_accounting():
    r=json.loads((AI/'eval/dark_only_normalization_v0_scorecard.json').read_text())
    ...
    assert r['corrected_counts']['darkened_standard']==200
