"""Measured P3E to P3 wrist-only contract and sampled geometry review."""
import hashlib
...
SOURCE_POSITIONS = (2047,2291,1825,2780,1784,2041,2047)
SOURCE_GOALS = (2047,2283,1831,2777,1785,2040,2047)
TARGET_GOALS = (2047,2283,1831,2777,1850,2040,2047)


def review_p3_wrist(raw, *, expected_boot, model_path):
    assessment = assess_large_pose_relief_record(raw, expected_boot=expected_boot, profile='P3E')
    endpoint = decode_large_pose_relief_record(raw, profile='P3E')['endpoint'][-1]['joints']
    ...
    if positions != SOURCE_POSITIONS or goals != SOURCE_GOALS:
        raise ValueError('Record differs from pinned measured P3E endpoint')
    ...
    return dict(schema='rocell.p3_wrist_review.v1', source_assessment=assessment,
        ...
        absolute_target_minus_measured_position_counts=66,
