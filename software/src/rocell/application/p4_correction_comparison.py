...
from .p4_repeat_campaign_review import GOALS, POSITIONS, MODEL_SHA

ORDER = ('baseline', 'candidate', 'candidate', 'baseline',
         'candidate', 'baseline', 'baseline', 'candidate')
DESIRED = 1947
COMMANDS = {'baseline': 1947, 'candidate': 1944}
...
def review_comparison(model_path):
    ...
    return dict(schema='rocell.p4_correction_comparison.v1', order=ORDER,
        ...
        hypothesis='Command 1944 may arrive at desired readback 1947 from above; unseen command, unvalidated',
        acceptance=dict(required_comparison_arrivals=8, arrivals_per_condition=4,
            candidate_max_absolute_desired_error_counts=1,
            minimum_mae_improvement_counts=2, candidate_max_spread_counts=2,
            no_increase_in_spread=True, require_all_16_legs_verified_and_exported=True),
        ...
        limitations=[
            ...
            'r72 cannot execute this route; new candidate contracts and tests required before deployment'],
