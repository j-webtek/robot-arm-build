// Exact measured P4E -> P4 wrist-only policy. Encoder-domain checks complement, but do not
// replace, the reviewed swept-geometry plan in LARGE_POSE_LADDER_PLAN.md.
#pragma once
#include "shoulder_characterization_policy.h"
#include <cstdlib>
namespace rocell_diag {
struct P4WristPolicy {
  static constexpr uint16_t source_goals[7]={2047,2217,1897,2711,1915,2040,2047};
  static constexpr uint16_t source_positions[7]={2047,2225,1890,2716,1912,2041,2047};
  static constexpr uint16_t target_goals[7]={2047,2217,1897,2711,1980,2040,2047};
