// Exact measured P2L -> P2 wrist-only policy. Encoder-domain checks complement, but do not
// replace, the reviewed swept-geometry plan in LARGE_POSE_LADDER_PLAN.md.
#pragma once
#include "shoulder_characterization_policy.h"
#include <cstdlib>
namespace rocell_diag {
struct P2WristPolicy {
  static constexpr uint16_t source_goals[7]={2047,2283,1831,2842,1719,2040,2047};
  static constexpr uint16_t source_positions[7]={2047,2291,1825,2844,1720,2041,2047};
  static constexpr uint16_t target_goals[7]={2047,2283,1831,2842,1785,2040,2047};
  static constexpr int selected[1]={4};

  static bool is_selected(int joint){return joint==4;}
