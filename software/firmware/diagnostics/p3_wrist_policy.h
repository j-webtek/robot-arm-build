// Exact measured P3E -> P3 wrist-only policy. Encoder-domain checks complement, but do not
// replace, the reviewed swept-geometry plan in LARGE_POSE_LADDER_PLAN.md.
#pragma once
#include "shoulder_characterization_policy.h"
#include <cstdlib>
namespace rocell_diag {
struct P3WristPolicy {
  static constexpr uint16_t source_goals[7]={2047,2283,1831,2777,1785,2040,2047};
  static constexpr uint16_t source_positions[7]={2047,2291,1825,2780,1784,2041,2047};
  static constexpr uint16_t target_goals[7]={2047,2283,1831,2777,1850,2040,2047};
