// Fixed six-leg, two-cycle noncontact A repeatability campaign.
// Separate reviewed candidate only; no client-supplied joint targets.
#pragma once
...
struct AirTypingPolicy {
  static constexpr unsigned legs=6;
  ...
  uint16_t source_goals[7]={2047,2075,2039,2600,2233,2040,2047};
  uint16_t source_positions[7]={2041,2081,2033,2609,2233,2041,2047};
  uint16_t target_goals[7]={2047,2093,2021,2618,2197,2040,2047};
