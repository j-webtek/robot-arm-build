// Seven fixed noncontact B-A continuation legs from the verified r76 endpoint.
// Installed as air_typing_policy.h only in the separate r77 candidate.
#pragma once
...
struct AirTypingPolicy {
  static constexpr unsigned legs=7;
  ...
  uint16_t source_goals[7]={1941,2098,2016,2609,2201,2040,2047};
  uint16_t source_positions[7]={1949,2099,2015,2610,2203,2041,2047};
  uint16_t target_goals[7]={1941,2111,2003,2621,2176,2040,2047};
