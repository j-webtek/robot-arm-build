...
struct P4CorrectionPolicy {
  uint16_t source_goals[7]={2047,2217,1897,2711,1980,2040,2047};
  uint16_t source_positions[7]={2047,2225,1890,2716,1977,2041,2047};
  uint16_t target_goals[7]={2047,2217,1897,2711,1947,2040,2047};
  static constexpr uint16_t targets[16]={1947,1980,1944,1980,1944,1980,1947,1980,1944,1980,1947,1980,1947,1980,1944,1980};
