...
| Production firmware candidate | r97 controller-side implementation compiled offline; source, integration, sealed review handoff, typed review-decision, synthetic rehearsal, and measured-epoch intake contracts are merged | Synthetic review can exercise integration but cannot satisfy epoch intake; no authenticated independent review decision or eight-component measured epoch evidence has been supplied, so installed qualification and all physical use remain blocked |
